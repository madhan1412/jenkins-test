	...
	when {
		changeset "**/chart/**"
			...
			sh "git config --global user.name \"jenkins\" && git config --global user.email jenkins@frbi.dev"
                        sh "git commit -am \"JENKINS:Auto-commit\" && git branch && git push https://madhan1412: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@github.com/madhan1412/awesome-go.git"
